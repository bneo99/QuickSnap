...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				SwinGame.DrawText ("Top Card is " + top.ToString (), Color.White, "GameFont", 5, 10); // was 1, 20
				SwinGame.DrawText ("Player 1 score: " + myGame.Score(0), Color.White, "GameFont", 5, 30); // was 1, 30
                SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.White, "GameFont", 5, 50); // was 1, 40
                SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 521, 153);
			}
			else
			{
				SwinGame.DrawText ("No card played yet...", Color.White, "GameFont", 5, 10); // was 1, 20
			}
